...
public class SyncSummary
{
    ...
    public void IncrementExported()           => Interlocked.Increment(ref _exported);
    public void IncrementSkippedTooLarge()    => Interlocked.Increment(ref _skippedTooLarge);
    public void IncrementSkippedUnsupported() => Interlocked.Increment(ref _skippedUnsupported);
    public void IncrementDeletesForbidden()   => Interlocked.Increment(ref _deletesForbidden);
